...
- Удалённый файл дерева: `openclaw/.metadata/FUHUO-FILES-TREE.json`
...
├── .metadata/
│   └── FUHUO-FILES-TREE.json    # Индекс дерева файлов
├── AGENTS.md
├── scripts/
├── config/
└── ...
...
1. Сохранить скрипт как `/root/clawd/scripts/fuhuo_relive.js` (уже сохранён)
